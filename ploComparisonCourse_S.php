...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PLO Comparison Course-wise</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">plo-comparison-course-wise</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 860px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">PLO Comparison Course-Wise</h6>
                </div><hr>
                <div class="card-body">
  ...
  <input style="background-color: #ffffff;height:36px;cursor: auto;border-radius: 5px;
        font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase; border: 1px solid; text-align:center;color:rgb(18, 18, 18);width:250px;margin-top:35px; margin-left: -20px" type="text" placeholder="Course ID" name="course"/>
...
<script>
  function view(){
    ...
    $sql="SELECT s.courseID AS course, SUM(g.marks) AS marks
    FROM section_t AS s, grade_t AS g 
    WHERE s.courseID = g.courseID
    GROUP BY s.courseID
    ORDER BY SUM(g.marks)";
