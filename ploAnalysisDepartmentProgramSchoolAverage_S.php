  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseEntry" class="collapse" aria-labelledby="headingEntry" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewExam.php">View Exam Paper</a>
          </div>
        </div>
      </li>
      <!-- / Data Entry -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row2" style="margin-left: 130px">
        <button onclick="ploAnalysisWithDepartmentAverage()" class="School-wise"> Department Average</button>
        <button onclick="ploAnalysisWithProgramAverage()" class="Department-wise"> Program Average</button>
        <button onclick="ploAnalysisWithSchoolAverage()" class="Program-wise"> School Average</button>
      </div>
