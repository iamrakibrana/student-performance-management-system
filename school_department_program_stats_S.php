      ...
      <li class="nav-item">
        ...
        <div id="collapseStatus" class="collapse" aria-labelledby="headingStatus" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="ploComparisonStudent_S.php">PLO Analysis (Student)</a>
            <a class="collapse-item" href="ploComparisonCourse_S.php">CLO Analysis (Course)</a>
          </div>
        </div>
      </li>
      <!-- / PLO Status -->
