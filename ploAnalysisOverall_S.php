      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="ploAnalysisDepartmentProgramSchoolAverage_S.php">PLO Analysis (Department,<br>Program, School Average)</a>
            <a class="collapse-item" href="ploAnalysisOverall_S.php">PLO Analysis (Overall,<br> CO wise, Course wise)</a>
          </div>
        </div>
      </li>
      <!-- / PLO Analysis -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseStatus" class="collapse" aria-labelledby="headingStatus" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="ploComparisonStudent_S.php">PLO Comparison (Student)</a>
            <a class="collapse-item" href="ploComparisonCourse_S.php">PLO Comparison (Course)</a>
            <a class="collapse-item" href="ploComparisonProgram_S.php">PLO Comparison (Program)</a>
            <a class="collapse-item" href="ploComparisonSchool_S.php">PLO Comparison (School)</a>
            <a class="collapse-item" href="ploComparisonDepartment_S.php">PLO Comparison (Dept)</a>
          </div>
        </div>
      </li>
      <!-- / PLO Status -->
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PLO Analysis</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">plo-analysis</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 860px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">PLO Analysis</h6>
                </div><hr>
                <div class="card-body">
                  <div class="chart-area">
                    <div>
                      <center>
        <form method="POST">
        <input style="background-color: #eaeaea;height:36px;cursor: auto;border-radius: 5px;
        font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase;border: 1px solid; text-align:center;color:rgb(18, 18, 18);width:250px;margin-top:35px;" type="text" placeholder="Enter Student ID . . ." name="studentID"/>

         <input class="submit_Button btn btn-outline-dark text-center" type="submit" name="submit" value="Submit"/>
         </form>
      </div>

      <div class="row2" style="margin-left: 230px">
        <button onclick="overallPlo()" class="School-wise"> Overall PLO</button>
        <button onclick="coWisePlo()" class="Department-wise"> CO-Wise PLO</button>
        <button onclick="courseWisePlo()" class="Program-wise"> Course-Wise PLO</button>
      </div>

     <div style="width:1000px; margin:auto; margin-top:20px;">     
         <canvas id="Autumn" style="width: 1000px; height: 530px; background-color: #EBEDEF; border-radius: 15px;"></canvas>  
      </div>
