      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Answer Script Submission</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">answer-script-submission</li>
            </ol>
          </div>
          ...
          <div class="row mb-3">
            ...
            <!-- select data -->
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 2800px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark"> Submit Answer Script</h6>
                </div><hr>
                <div class="card-body">
 ...
 $year=$_SESSION['year'];
  ...
  $questionDetails=$row['questionDetails'];
    ...
    <div>
     ...
     <div style="padding-top:10px;border:3px solid rgb(0, 131, 143);">
       <label class="question-form">
         Question :
       </label>
...
<div style="display:flex;justify-content:center;">
       <div style="border:3px solid #eeeff0;width:75%;">
   ...
   <input class="submit_Button btn btn-outline-dark text-center" type="submit" name="submitAnswerScript" value="Submit"/>
</form>  
</div>   
                  </div>
                </div>
