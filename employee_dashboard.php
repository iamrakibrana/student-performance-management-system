        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">faculty-ashboard</li>
            </ol>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-xl-8 col-lg-7 mb-4">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h5 class="m-0 font-weight-bold text-dark">Faculty</h5>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Nashid</td>
                        <td>Sultana</td>
                        <td><span class="badge badge-warning">Study Leave</span></td>
                      ...
                      <tr>
                        ...
                        <td>Haroun Er</td>
                        <td>Rashid</td>
                        <td><span class="badge badge-danger">retired</span></td>
                        <td><a href="#" class="btn btn-sm btn-primary">Detail</a></td>
                      </tr>
                      <tr>
                        <td><a href="#">3329</a></td>
                ...
                <div>
                  <div class="customer-message align-items-center">
                    <a class="font-weight-bold" href="#">
                      <div class="text-truncate text-dark  message-title">Thank you sir for joining us, inspiring us,making us special.</div>
                      <div class="small text-gray-500 message-time font-weight-bold">Rafiul Islam · 58m</div>
                    </a>
                  </div>
                  <div class="customer-message align-items-center">
                    <a href="#">
                      <div class="text-truncate text-dark message-title">Sir, I have problem today. I can't attend today's class . . .
                      </div>
                      <div class="small text-gray-500 message-time">Rakib Rana · 2h</div>
                    </a>
                  </div>
                  <div class="customer-message align-items-center">
                    <a class="font-weight-bold" href="#">
                      <div class="text-truncate text-dark message-title">Congratulations on Teachers’ Day! Thank you for always being a source of genuine encouragement and motivation for the student.
                      </div>
                      <div class="small text-gray-500 message-time font-weight-bold">Rabiul Islam · 1d</div>
                    </a>
                  </div>
                  <div class="customer-message align-items-center">
                    <a class="font-weight-bold" href="#">
                      <div class="text-truncate text-dark message-title">I am reaching out to talk about receiving a ‘60%’ on my recent exam and to check in about opportunities to improve my overall grade in class. I am hoping to receive an “B-” by the end of the semester.
                      </div>
                      <div class="small text-gray-500 message-time font-weight-bold">Random · 1w</div>
                    </a>
                  </div>
                  <div class="card-footer text-center">
                    <a class="m-0 small text-primary card-link" href="#">View More <i
