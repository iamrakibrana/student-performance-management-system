      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Student Answer Script</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">student-answer-script</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 860px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark"> View Exam</h6>
                </div><hr>
                <div class="card-body">
...
<center>
<form method="POST">
<input class="btn-outline-dark" type="text" style="background-color: #fef9e7;height:36px;cursor: auto;border-radius: 5px;
      font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase; border: .2px black;
 ...
 <select style="margin-left: 10px;" name="courseID" class="select">
    ...
    <option value="CSC303">EEE131</option>
...
<br>
   ...
   <input class="submit_Button btn btn-outline-dark text-center mt-3 px-3" style="font-size: 20px" type="submit" name="submit" value="Submit"/>
</form>  
</div>   
                  </div>
                </div>
