      ...
      <li class="nav-item">
        ...
        <div id="collapseStatus" class="collapse" aria-labelledby="headingStatus" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="ploComparisonStudent_S.php">PLO Comparison</a>
            <a class="collapse-item" href="ploComparisonCourse_S.php">CLO Comparison</a>
          </div>
        </div>
      </li>
      <!-- / PLO Status -->
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Instructor Wise Performance</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">instructor-wise</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 860px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Instructor</h6>
                </div><hr>
                <div class="card-body">
...
<div style="padding-left: 300px; margin-top: 20px; height:50px" class="row2">
      <select name="courseInstructor1" class="select"   style="margin-left: 12%; width:250px;height:100%;margin-top:0px;">
...
<div style="height: 50px;padding-left: 43%;margin-top: 15px;">
  <button onclick="viewInstructorWise()" class="view">
    view
  </button>
</div>
