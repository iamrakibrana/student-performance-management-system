            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 700px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Generate Grade</h6>
                </div><hr>
                <div class="card-body">
        ...
        <div class="screen-body-item">
          <div class="app-form">
            <div class="app-form-group">
              <input type="text" class="app-form-control" placeholder="SUBJECT 1" id="s1">
            </div>
            <div class="app-form-group">
              <input  type="text"  class="app-form-control"   placeholder="SUBJECT 2" id="s2">
            </div>
             <div class="app-form-group">
              <input  type="text"  class="app-form-control"   placeholder="SUBJECT 3" id="s3">
            </div>
            <div class="app-form-group">
              <input  type="text"  class="app-form-control"   placeholder="SUBJECT 4" id="s4" >
            </div>
            <div > 
              <input type="button" name="" value="show" class="app-form-button" onclick="calcy()">
            </div>            
          </div>
      </div>
...
const calcy = () =>{
  ...
  if(perc <= 100  && perc >= 90){
    grades = 'A';
  }else if(perc < 90  && perc >= 86){
     grades = 'A-';
  }else if(perc < 86  && perc >= 80){
     grades = 'B+';
    }else if(perc < 80  && perc >= 76){
     grades = 'B';
    }else if(perc < 76  && perc >= 70){
     grades = 'B-';
    }else if(perc < 70  && perc >= 66){
     grades = 'C+';
    }else if(perc < 66  && perc >= 60){
     grades = 'C';
    }else if(perc < 60  && perc >= 56){
     grades = 'C-';
    }else if(perc < 56  && perc >= 51){
     grades = 'D';
  }else{
     grades = 'F';
  }
  ...
  if(perc > 50){
    document.getElementById('showData').innerHTML = ` Total Marks: 400 <br> Obtained marks:  ${totalGrades} <br> Percentage: ${perc}%. <br> Your grade: ${grades}. <br> Congratulations! You Passed. `
  }
  else{
    document.getElementById('showData').innerHTML = ` Total Marks: 400 <br> Obtained marks:  ${totalGrades} <br> Percentage: ${perc}%. <br> Your grade: ${grades}. <br> Opps! You Failed. `
  }
