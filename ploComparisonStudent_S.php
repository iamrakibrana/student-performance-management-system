      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PLO Student-Wise Comparison</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">plo-comparison-student-wise</li>
            </ol>
          </div>
...
<script>
  function view(){
    ...
    $sql="SELECT c.courseID AS course, SUM(g.marks) AS marks
    FROM course_t AS c, grade_t AS g
