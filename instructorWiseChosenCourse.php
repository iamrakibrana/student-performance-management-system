...
<head>
  ...
  <title>Instructor Wise Performance (Chosen)</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Instructor Wise Course</h1>
            <ol class="breadcrumb">
  ...
  <select style="margin-left: 10px;" name="courseCode" class="select-a">
...
<div style="height:50px;padding-left:43%;margin-top:15px;">
  <button onclick="viewInstructorWiseChosenCourse()" class="view">
    view
  </button>
</div>
