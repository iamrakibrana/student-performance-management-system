      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Spider Chart</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">spider-chart</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 860px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Generate Spider Chart</h6>
                </div><hr>
                <div class="card-body">
...
<center>
<form method="POST">
<input style="margin-bottom:0px;" class="studentID btn btn-outline-dark text-center" type="text" placeholder="Enter Student ID" name="studentID"/>
...
<div class="background">
  <div class="row2">
    <button onclick="poView()" class="School-wise">View PO Analysis</button>
    <!-- <button onclick="departmentWiseEnrollment()" class="Department-wise">Department-wise</button> -->
    <button onclick="coView()" class="Program-wise">View CO Analysis</button>
</div>
      <div style="width:1000px; margin:auto; margin-top:20px;">     
         <canvas id="myChart" style="width: 1000px; height: 530px; background-color: #EBEDEF; border-radius: 15px;"></canvas>  
      </div>
</div>
</center>
                  </div>
