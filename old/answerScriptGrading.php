...
<div class="nav" style="background-color: #008080; margin-bottom: 50px;">
   ...
   $year=$_SESSION['year'];
    ...
    $answerScript=$row['answerDetails'];
      ...
      <div>
       ...
       <div style="padding-top:10px; border:3px solid #03d5c4d5;">
         <label class="question-form">
           Question :
         </label>
  ...
  <p class="heading" style="background-color: #161616; color: whitesmoke; padding: 10px;">Exam Evaluation</p>
  ...
  <form method="post">
    ...
    <div style="display:flex;justify-content:center;">
      <div class="form-container">
        ...
        <input style="margin-bottom:0px;" class="studentID" type="text" placeholder="Enter Mark Obtained for Question-7"
          name="ansMark7" />
      </div>
    </div>
