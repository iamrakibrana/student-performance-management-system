  ...
  <div class="nav" style="background-color: #008080; margin-bottom: 50px;">
    ...
    <div class="nav-links">
      <ul>
        ...
        <li><a class="nav-link" href="ploAchieveStats.php" target="_self">PLO Achievement Stats</a></li>
        <li><a class="nav-link" href="ploAchieveStats.php" target="_self">Spider Chart Analysis</a></li>
...
<!-- div row-1 starts here -->
    ...
    <input style="margin-bottom:0px;" class="submitButton" type="submit" name="submit" value="Enter"/>
    ...
    <div style="display:flex;justify-content:center;margin: 30px 30px;">
        ...
        <button onclick="poView()" style="width:400px;" class="view">view PO analysis</button>
        <button onclick="coView()" style="width:400px;" class="view">View CO analysis</button>
    
    </div> <!-- div row-2 ends here -->

        <div style="display:flex;justify-content:center;margin-top:5px;height:600px;width:100%;"class="row3"> 
        <canvas style="background-color: #bbdada;height:500px;width:400px;" id="myChart"></canvas>
