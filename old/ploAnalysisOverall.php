  ...
  <div class="nav" style="background-color: #008080; margin-bottom: 50px;">
    ...
    <div class="nav-links">
      <ul>
        ...
        <li><a class="nav-link" href="ploAnalysisDepartmentProgramSchoolAverage.php" target="_self">PLO Analysis With
            Department/Program/School Average</a></li>
        <li><a class="nav-link" href="ploAnalysisOverall.php" target="_self">PLO Analysis (Overall, CO Wise, Course
            Wise)</a></li>
