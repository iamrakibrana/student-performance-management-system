      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-black small">User</span>
              </a>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Give Your Exam</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">give-exam</li>
            </ol>
          </div>
          ...
          <div class="row mb-3">
            ...
            <!-- Data section -->
            <div class="col-lg-12">
              <div class="card mb-4" style="height: 1020px">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">Give Exam</h6>
                </div><hr>
                <div class="card-body">
...
<input class="btn-outline-dark" type="text" style="background-color:#ffffff;height:36px;cursor: auto;border-radius: 5px;
...
outline:none;text-align:center;color:rgb(18, 18, 18);width:250px;margin-top:0px;"
    placeholder="Please Enter Your Name" /*name="examName"*/ />


    <input class="btn-outline-dark" type="text" style="background-color:#ffffff;height:36px;cursor: auto;border-radius: 5px;
font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase;border: none;
outline:none;text-align:center;color:rgb(18, 18, 18);width:250px;margin-top:0px;"
    placeholder="Please Enter Your ID" name="studentID" />

    <input class="btn-outline-dark" type="text" style="background-color:#ffffff;height:36px;cursor: auto;border-radius: 5px;
font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase;border: none;
outline:none;text-align:center;color:rgb(18, 18, 18);width: 273px;margin-top:0px;"
    placeholder="Please Enter Your Section" /*name="examName"*/ />
...
font-size: 14px;letter-spacing:2px;font-weight: bold;text-transform: uppercase;border: none;
outline:none;text-align:center;color:rgb(18, 18, 18);width:250px;margin-top:0px;"
    placeholder="Enter the Course Name" name="courseID" />
...
<select style="width:273px;margin-top:0px;margin-left:0px;" name="year" class="select">
...
<br>
    <input class="submit_Button btn btn-outline-dark text-center" type="submit" name="submit" value="Enter"/>
</div>
</div>
  </form>
<!-- </div> -->
